...
class InternalUserControllerTest {
    ...
    void shouldReturnUserInfoById() throws Exception {
        ...
        mockMvc.perform(get("/api/internal/users/{id}", userId))
    ...
    void shouldReturnIdsByKeyword() throws Exception {
        ...
        mockMvc.perform(get("/api/internal/users/search/id").param("keyword", "jo"))
                .andExpect(status().isOk())
    ...
    void shouldReturnUsernamesByIds() throws Exception {
        ...
        mockMvc.perform(get("/api/internal/users/search/names")
                        .param("authorIds", firstId.toString(), secondId.toString())
