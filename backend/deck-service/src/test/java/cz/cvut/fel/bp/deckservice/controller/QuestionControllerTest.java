...
class QuestionControllerTest {
    ...
    void shouldCreateQuestionWhenAuthenticated() throws Exception {
        ...
        mockMvc.perform(post("/api/decks/10/questions")
                        .with(authentication(userAuthentication()))
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isCreated())
                .andExpect(header().string("Location", org.hamcrest.Matchers.containsString("/api/decks/10/questions/66")))
    ...
    void shouldUpdateQuestionWhenAuthenticated() throws Exception {
        ...
        mockMvc.perform(put("/api/decks/10/questions/77")
                        .with(authentication(userAuthentication()))
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request)))
    ...
    void shouldDeleteQuestionWhenAuthenticated() throws Exception {
        ...
        mockMvc.perform(delete("/api/decks/10/questions/88")
                        .with(authentication(userAuthentication())))
    ...
    void shouldReturnNotFoundWhenUpdatingMissingQuestion() throws Exception {
        ...
        mockMvc.perform(put("/api/decks/10/questions/404")
                        .with(authentication(userAuthentication()))
                        .contentType(MediaType.APPLICATION_JSON)
