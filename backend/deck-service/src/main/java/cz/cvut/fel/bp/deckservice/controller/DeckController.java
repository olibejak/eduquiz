...
public class DeckController {
    ...
    public Slice<DeckSummaryResponseDTO> getDecksByAuthorId(
            @RequestParam UUID authorId,
            Pageable pageable) {
        log.debug("Search decks by authorId={}, page={}, size={}", authorId, pageable.getPageNumber(), pageable.getPageSize());
        return deckServiceFacade.getDecksByAuthorId(authorId, pageable);
    }
