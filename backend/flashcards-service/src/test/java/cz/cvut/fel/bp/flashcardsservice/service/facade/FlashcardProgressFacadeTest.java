...
class FlashcardProgressFacadeTest {
    ...
    @Test
    void testGetDeckStatus_ReturnsDefaultStatusWhenDeckHasNoQuestions() {
        // Given
        when(deckServiceClient.getDeckName(deckId)).thenReturn("Test Deck");
        ...
        assertEquals(0, result.learnedCount());
        assertEquals(0, result.newCount());
        assertEquals(0, result.totalCount());
    }

    @Test
    void testGetDeckStatus_ReturnsDefaultStatusWhenDeckNotFound() {
        // Given
        when(deckServiceClient.getDeckName(deckId)).thenReturn(null);
    ...
    void testGetDueDecksDashboard_ReturnsDeckSummaries() {
        ...
        assertTrue(content.stream().anyMatch(d -> d.title().equals("Deck 1")));
        assertTrue(content.stream().anyMatch(d -> d.title().equals("Deck 2")));
    }
