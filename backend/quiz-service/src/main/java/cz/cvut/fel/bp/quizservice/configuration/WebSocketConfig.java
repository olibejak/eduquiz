...
import cz.cvut.fel.bp.quizservice.security.QuizTokenAuthInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    private final QuizTokenAuthInterceptor quizTokenAuthInterceptor;
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/ws-quiz")
                .setAllowedOrigins("https://bp-eduquiz-app.vercel.app", "http://localhost:5173")
                ;//.withSockJS();
    }

    @Override
    public void configureClientInboundChannel(ChannelRegistration registration) {
        registration.interceptors(quizTokenAuthInterceptor);
    }
}
