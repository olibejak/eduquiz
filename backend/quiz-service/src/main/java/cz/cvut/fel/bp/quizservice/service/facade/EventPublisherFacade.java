...
public class EventPublisherFacade {
    ...
    public void publishQuizEnded(String lobbyPin, List<UserQuizResultsDTO> results, List<String> deckTitles) {
        publish(new QuizEndedEvent(lobbyPin, results, LocalDateTime.now(), deckTitles));
    }
